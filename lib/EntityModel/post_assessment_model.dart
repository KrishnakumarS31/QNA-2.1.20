...
PostAssessmentModel postAssessmentModelFromJson(String str) =>
    PostAssessmentModel.fromJson(json.decode(str));

String postAssessmentModelToJson(PostAssessmentModel data) =>
...
class PostAssessmentModel {
  ...
  factory PostAssessmentModel.fromJson(Map<String, dynamic> json) =>
      PostAssessmentModel(
...
class AssessmentResult {
  ...
  factory AssessmentResult.fromJson(Map<String, dynamic> json) =>
      AssessmentResult(
        ...
        selectedQuestionChoice:
            List<int>.from(json["selected_question_choice"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "marks": marks,
        "selected_question_choice": selectedQuestionChoice == null
            ? []
            : List<dynamic>.from(selectedQuestionChoice!.map((x) => x)),
