...
class Question {
  ...
  factory Question.fromJson(Map<String, dynamic> json) => Question(
        ...
        questionMarks:
            json["question_marks"] == null ? null : json["question_marks"],
        questionType: json["question_type"],
        question: json["question"],
        choices:
            List<Choice>.from(json["choices"].map((x) => Choice.fromJson(x))),
        rightChoice: json["right_choice"] == null
            ? []
            : List<int>.from(json["right_choice"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "right_choice": rightChoice == null
            ? null
            : List<dynamic>.from(rightChoice.map((x) => x)),
