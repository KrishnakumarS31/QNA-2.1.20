...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        accessTokenDetails: json["access_token_details"] == null
            ? AccessTokenDetails()
            : AccessTokenDetails.fromJson(json["access_token_details"]),
      );
...
class AccessTokenDetails {
  ...
  factory AccessTokenDetails.fromJson(Map<String, dynamic> json) =>
      AccessTokenDetails(
