...
class EditQuestionModel {
  ...
  @override
  String toString() {
    return 'EditQuestionModel{question: $question, subject: $subject, topic: $topic, subTopic: $semester, editQuestionModelClass: $editQuestionModelClass, advisorText: $advisorText, advisorUrl: $advisorUrl, editChoices: $editChoices, addChoices: $addChoices, removeChoices: $removeChoices}';
  }
}
