...
DemoSubmitAnswer? demoSubmitAnswerFromJson(String str) =>
    DemoSubmitAnswer.fromJson(json.decode(str));

String demoSubmitAnswerToJson(DemoSubmitAnswer? data) =>
...
class DemoSubmitAnswer {
  ...
  factory DemoSubmitAnswer.fromJson(Map<String, dynamic> json) =>
      DemoSubmitAnswer(
        userId: json["user_id"],
        ...
        assessmentResultHeader: json["assessment_result_header"] == null
            ? []
            : List<AssessmentResultHeader?>.from(
                json["assessment_result_header"]!
                    .map((x) => AssessmentResultHeader.fromJson(x))),
        assessmentResultDetail: json["assessment_result_detail"] == null
            ? []
            : List<AssessmentResultDetail?>.from(
                json["assessment_result_detail"]!
                    .map((x) => AssessmentResultDetail.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "assessment_result_header": assessmentResultHeader == null
            ? []
            : List<dynamic>.from(
                assessmentResultHeader!.map((x) => x!.toJson())),
        "assessment_result_detail": assessmentResultDetail == null
            ? []
            : List<dynamic>.from(
                assessmentResultDetail!.map((x) => x!.toJson())),
      };
}
...
class AssessmentResultDetail {
  ...
  factory AssessmentResultDetail.fromJson(Map<String, dynamic> json) =>
      AssessmentResultDetail(
        ...
        selectedQuestionChoiceId: json["selected_question_choice_id"] == null
            ? []
            : List<int?>.from(
                json["selected_question_choice_id"]!.map((x) => x)),
        descriptiveText: json["descriptive_text"] == null
            ? []
            : json["descriptive_text"] == null
                ? []
                : List<String?>.from(json["descriptive_text"]!.map((x) => x)),
      );

  Map<String, dynamic> toJson() => {
        "question_id": questionId,
        "selected_question_choice_id": selectedQuestionChoiceId == null
            ? []
            : List<dynamic>.from(selectedQuestionChoiceId!.map((x) => x)),
        "descriptive_text": descriptiveText == null
            ? []
            : descriptiveText == null
                ? []
                : List<dynamic>.from(descriptiveText!.map((x) => x)),
      };
}
...
class AssessmentResultHeader {
  ...
  factory AssessmentResultHeader.fromJson(Map<String, dynamic> json) =>
      AssessmentResultHeader(
        questionId: json["question_id"],
