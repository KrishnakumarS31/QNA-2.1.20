...
class DraftAssessmentLanding extends StatefulWidget {
  DraftAssessmentLanding({
    Key? key,
  }) : super(key: key);
  ...
  @override
  DraftAssessmentLandingState createState() => DraftAssessmentLandingState();
}

class DraftAssessmentLandingState extends State<DraftAssessmentLanding> {
