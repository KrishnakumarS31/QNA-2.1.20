...
class CreateNewAssessment extends StatefulWidget {
  CreateNewAssessment({
    Key? key,
  }) : super(key: key);
  ...
  @override
  CreateNewAssessmentState createState() =>
      CreateNewAssessmentState();
}

class CreateNewAssessmentState extends State<CreateNewAssessment> {
  ...
  showDialogSave(BuildContext context, double height,double width) {
    // set up the buttons
    Widget cancelButton = ElevatedButton(
      style: ElevatedButton.styleFrom(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ElevatedButton(
                                          onPressed: () {
                                            showDialogSave(context,height,width);
                                          },
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsets.only(
                                          left: width * 0.02, right: width * 0.02,top:width * 0.02,bottom:width * 0.02),
                                      child: Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                      Text(
