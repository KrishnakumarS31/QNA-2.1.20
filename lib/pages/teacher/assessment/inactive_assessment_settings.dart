...
class InactiveAssessmentSettings extends StatefulWidget {
  ...
  @override
  InactiveAssessmentSettingsState createState() =>
      InactiveAssessmentSettingsState();
}

class InactiveAssessmentSettingsState extends State<InactiveAssessmentSettings> {
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              ...
                                              child: Padding(
                                                padding:  EdgeInsets.only(left : width * 0.03,bottom:height * 0.03),
                                                child: SizedBox(
                                                  width: width * 0.11,
                                                  child: TextField(
                                                    enabled: false,
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            category == 'Test' ?
                                            Padding(
                                              padding:  EdgeInsets.only(left : width * 0.03,right:width*0.03,bottom:height * 0.03),
                                              child: Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  SizedBox(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding:  EdgeInsets.only(left : width * 0.03,top: height * 0.015,right:width*0.03,bottom:height * 0.03),
                                              child: Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  SizedBox(
                                    ...
                                    children: [
                                      ElevatedButton(
                                        onPressed: () async {
                                          ...
                                          assessment.subject=getAssessmentModel.subject;
                                          assessment.topic=getAssessmentModel.topic;
