...
class ReviewClonedAssessment extends StatefulWidget {
  ...
  @override
  ReviewClonedAssessmentState createState() => ReviewClonedAssessmentState();
}

class ReviewClonedAssessmentState extends State<ReviewClonedAssessment> {
  ...
  showQuestionPreview(BuildContext context, questionModel.Question question) {
    return showDialog(
      context: context,
      builder: (BuildContext context) {
        return EditQuestionPopUpReviewQuestions(question: question);
      },
    );
  }
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (valid) {
                                                                      for (int i =
                                                                          ...
                                                                          i++) {
                                                                        questionList[i].subject =
                                                                            subjectController.text;
                                                                        questionList[i].topic =
                                                                            topicController.text;
                                                                        questionList[i].degreeStudent =
                                                                            degreeController.text;
                                                                        questionList[i].semester =
                                                                            semesterController.text;
                                                                        Provider.of<QuestionPrepareProviderFinal>(context, listen: false).updateQuestionList(
                                                                            i,
                                                                            questionList[i]);
                                                                      }
                                                                      assessment
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          if (questionList[i].questionMark != null ||
                                                                            ...
                                                                            questionList[i].questionMark =
                                                                                questionList[i].questionMark! - 1;
                                                                            Provider.of<QuestionPrepareProviderFinal>(context, listen: false).updatemark(questionList[i].questionMark!,
                                                                                i);
                                                                            setState(() {
                                                                              totalMarks--;
                                                                            });
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            border:
                                                                                Border.all(
                                                                              color: const Color.fromRGBO(28, 78, 80, 0.5),
                                                                            ),
                                                                            borderRadius:
                                                                      ...
                                                                      GestureDetector(
                                                                        onTap:
                                                                            () {
                                                                          if (questionList[i].questionMark !=
                                                                              null) {
                                                                            questionList[i].questionMark =
                                                                                questionList[i].questionMark! + 1;
                                                                            Provider.of<QuestionPrepareProviderFinal>(context, listen: false).updatemark(questionList[i].questionMark!,
                                  ...
                                  ElevatedButton(
                                    onPressed: () async {
                                      ...
                                      if (statusCode.code == 200) {
                                        assessmentCode = statusCode.data
                                            .toString()
                                            .substring(
                                                18,
                                                statusCode.data
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Padding(
                                                                            padding:
                                                                                EdgeInsets.only(right: width * 0.005, left: width * 0.005),
                                                                            child:
                                                                                Container(
                                                                              height: height * 0.03,
                                                                              width: width * 0.05,
...
class EditQuestionPopUpReviewQuestions extends StatefulWidget {
  ...
  @override
  EditQuestionPopUpReviewQuestionsState createState() =>
      EditQuestionPopUpReviewQuestionsState();
}

class EditQuestionPopUpReviewQuestionsState
    extends State<EditQuestionPopUpReviewQuestions> {
    ...
    return Column(
      children: [
        for (int j = 0; j < widget.question.choices!.length; j++)
          Padding(
            padding: EdgeInsets.only(
                bottom: widget.height * 0.013, left: widget.width * 0.03),
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              ...
                              style: TextStyle(
                                color: (widget
                                        .question.choices![j].rightChoice!)
                                    ? const Color.fromRGBO(255, 255, 255, 1)
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          border: Border.all(
            color: Color.fromRGBO(82, 165, 160, 0.5),
          ),
          borderRadius: BorderRadius.all(Radius.circular(5)),
        ),
        child: Padding(
          ...
          child: Column(
            children: [
                              ...
                              onTap: () {
                                if (widget.question.questionMark != null ||
                                  ...
                                  Provider.of<QuestionPrepareProviderFinal>(
                                          context,
                                          listen: false)
                                      .updatemark(widget.question.questionMark!,
                                          widget.quesIndex);
                                  setState(() {});
                                }
                              },
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  border: Border.all(
                                    color:
                                        const Color.fromRGBO(28, 78, 80, 0.5),
                                  ),
                                  borderRadius:
                                      BorderRadius.all(Radius.circular(5)),
                                ),
              ...
              Align(
                  ...
                  child: IconButton(
                    onPressed: () async {
                      bool res = await alertDialogDeleteQuestion(
                          context, widget.height);
                      setState(() {
                        widget.quesList;
                      });
