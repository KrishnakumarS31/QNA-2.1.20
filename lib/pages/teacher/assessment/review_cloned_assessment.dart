...
class ReviewClonedAssessment extends StatefulWidget {
  ...
  @override
  ReviewClonedAssessmentState createState() =>
      ReviewClonedAssessmentState();
}
                                                        ...
                                                        return Dialog(
                                                          shape: const RoundedRectangleBorder(
                                                              borderRadius: BorderRadius.all(
                                                                  Radius.circular(17))),
                                                          child:
                                                          QuestionPreview(height: height,quesIndex:questionStart,quesList:questionList,question:questionList[i],width:width),
                                                        );
                                                      });
    ...
    return Column(
      children: [
        for (int j = 0; j < widget.question.choices!.length; j++)
          Padding(
            padding: EdgeInsets.only(bottom: widget.height * 0.013,left: widget.width * 0.03),
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
