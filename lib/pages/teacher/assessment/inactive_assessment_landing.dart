...
class InactiveAssessmentLanding extends StatefulWidget {
  InactiveAssessmentLanding({
    Key? key,
  }) : super(key: key);
  ...
  @override
  InactiveAssessmentLandingState createState() =>
      InactiveAssessmentLandingState();
}

class InactiveAssessmentLandingState extends State<InactiveAssessmentLanding> {
  ...
  reactivateAssessment(BuildContext context, double height,double width) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text(
        //AppLocalizations.of(context)!.want_to_del_qn,
        'Are you sure you want to reactivate this assessment?',
        style: TextStyle(
            fontSize: height * 0.02,
            fontFamily: "Inter",
            color: const Color.fromRGBO(51, 51, 51, 1),
