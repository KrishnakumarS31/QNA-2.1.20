...
class EditQuestionNewFlow extends StatefulWidget {
  EditQuestionNewFlow(
      {Key? key,required this.questionIndex})
      : super(key: key);
  int questionIndex;

  @override
  EditQuestionNewFlowState createState() => EditQuestionNewFlowState();
}

class EditQuestionNewFlowState extends State<EditQuestionNewFlow> {
  ...
  Question questionMvp2=Question();
  ...
  void initState() {
    super.initState();
    List<Question> quesList =Provider.of<QuestionPrepareProviderFinal>(context, listen: false).getAllQuestion;
    setState(() {
      questionMvp2=quesList[widget.questionIndex];
      _questionTypeValue=questionMvp2.questionType!;
      questionController.text=questionMvp2.question!;
      adviceController.text=questionMvp2.advisorText!;
      urlController.text=questionMvp2.advisorUrl!;
      if(questionMvp2.questionType!='Descriptive'){
        for(int i=0;i<questionMvp2.choices!.length;i++){
          tempChoiceList.add(questionMvp2.choices![i]);
          TextEditingController tempChoice = TextEditingController();
          tempChoice.text=questionMvp2.choices![i].choiceText!;
          chooses.add(tempChoice);
          radioList.add(questionMvp2.choices![i].rightChoice!);
        }
      }
    });
    //setData();
                                ...
                                children: [
                                  ElevatedButton(
                                    onPressed: () {
                                      ...
                                      Provider.of<QuestionPrepareProviderFinal>(context, listen: false).updateQuestionList(widget.questionIndex, question);
                                      Navigator.pushNamed(
                                        context,
                                        '/inprogressQuestionBank',
                                      );
                              ...
                              Column(
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    child: Icon(Icons.close,size:height * 0.05, color: const Color.fromRGBO(82, 165, 160, 1),),
                                    style: ElevatedButton.styleFrom(
                                      side: const BorderSide(
                                        width: 2,
                                        color: const Color.fromRGBO(82, 165, 160, 1),
                              ...
                              Column(
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    child: Icon(Icons.check,size:height * 0.05, color: Colors.white),
                                    style: ElevatedButton.styleFrom(
                                      side: const BorderSide(
                                        width: 2,
                                        color: const Color.fromRGBO(82, 165, 160, 1),
                              ...
                              Column(
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    child: Icon(Icons.close, color: const Color.fromRGBO(82, 165, 160, 1),),
                                    style: ElevatedButton.styleFrom(
                                      side: const BorderSide(
                                        width: 2,
                                        color: const Color.fromRGBO(82, 165, 160, 1),
