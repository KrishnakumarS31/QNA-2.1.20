...
class CreateNewQuestion extends StatefulWidget {
  const CreateNewQuestion({Key? key}) : super(key: key);
                    ...
                    ? Scaffold(
                        ...
                        appBar: AppBar(
                          iconTheme: IconThemeData(
                              color: appBarChevronColor, size: height * 0.08),
                          elevation: 0,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            for (int i = 0;
                                                                                ...
                                                                                i++)
                                                                              Padding(
                                                                                padding: EdgeInsets.only(bottom: height * 0.02, left: 8, top: height * 0.01),
                                                                                child: Row(
                                                                                ...
                                                                                child: Row(
                                                                                  children: [
                                                                                    ...
                                                                                    Expanded(
                                                                                      child: TextFormField(
                                                                                        controller: chooses[i],
                                                                                        style: TextStyle(color: Colors.black, fontFamily: 'Inter', fontWeight: FontWeight.w400, fontSize: height * 0.035),
                                                                                        keyboardType: TextInputType.multiline,
                                                                                        maxLines: null,
                                                                                        decoration: InputDecoration(
                                                                                          floatingLabelBehavior: FloatingLabelBehavior.always,
                                                                                          hintStyle: TextStyle(color: const Color.fromRGBO(102, 102, 102, 0.3), fontFamily: 'Inter', fontWeight: FontWeight.w400, fontSize: height * 0.035),
                                                                                          hintText: AppLocalizations.of(context)!.type_op_here,
                                                                                          //"Type Option Here",
                                                                                          border: OutlineInputBorder(borderRadius: BorderRadius.circular(5)),
                                                                                        ),
                                                                                ...
                                                                                child: Row(
                                                                                  ...
                                                                                  children: [
                                                                                    SizedBox(
                                                                                        ...
                                                                                        child: Text(
                                                                                          "${String.fromCharCode(97 + i)}.",
                                                                                          style: TextStyle(color: Colors.black, fontFamily: 'Inter', fontWeight: FontWeight.w400, fontSize: height * 0.05),
                                                                                        )),
                                                                                    Container(
                                                                                      width: width * 0.59,
                                                                                      child: TextFormField(
                                      ...
                                      children: [
                                        ElevatedButton(
                                          onPressed: () {
                                            ...
                                            if (_questionTypeValue ==
                                                'Descriptive') {
                                              finalQuestion.choices = [];
                                            }

                                            if (_questionTypeValue == 'MCQ') {
                                              var values = finalQuestion
                                                  .choices!
                                                  .where((element) =>
                                                      element.rightChoice ==
                                                      true);
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                SizedBox(
                                                                                  width: width * 0.05,
                                                                                  child: Text("${String.fromCharCode(97 + i)}.", style: TextStyle(color: Colors.black, fontFamily: 'Inter', fontWeight: FontWeight.w400, fontSize: height * 0.020)),
                                                                                ),
                                                                                SizedBox(
                                                                                  //height: height * 0.05,
                                                                                  width: width * 0.28,
