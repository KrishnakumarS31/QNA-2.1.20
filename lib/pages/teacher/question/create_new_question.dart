    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        if (constraints.maxWidth<= 960 && constraints.maxWidth>=500) {
                                  ...
                                  ElevatedButton(
                                    onPressed: () {
                                      ...
                                      finalQuestion.questionType =
                                          _groupValue;
                                      if((questionController.text == null || questionController.text.isEmpty) || (subjectController.text == null || subjectController.text.isEmpty))
                                      {
                                        Navigator.push(
                                          context,
                                          PageTransition(
                                            ...
                                            child: CustomDialog(
                                              title: "Alert",
                                              // "OOPS!",
                                              content: "Please check you have entered the question and subject",
                                      ...
                                      else if (_groupValue == 'Descriptive') {
                                        finalQuestion.choices = [];
                                      }
                                        ...
                                        print("TEMP CHOICE LIST");
                                        print(tempChoiceList);
                                ...
                                children: [
                                  ElevatedButton(
                                    onPressed: () {
                                      ...
                                      if(_groupValue == 'MCQ' && tempChoiceList.isEmpty)
                                      {
                                        print("INSIDE IF");
                                        Navigator.push(
                                          context,
                                      ...
                                      else if((questionController.text == null || questionController.text.isEmpty) || (subjectController.text == null || subjectController.text.isEmpty))
                                      {
          ...
          {
            print("INSIDE WEB QUESTION CREATION ");
            return WillPopScope(
                onWillPop: () async => false,
                child: Scaffold(
                    resizeToAvoidBottomInset: true,
