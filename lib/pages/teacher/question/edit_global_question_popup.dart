...
class EditGlobalQuestionPopUp extends StatefulWidget {
  const EditGlobalQuestionPopUp({
    Key? key,
  ...
  @override
  EditGlobalQuestionPopUpState createState() => EditGlobalQuestionPopUpState();
}

class EditGlobalQuestionPopUpState extends State<EditGlobalQuestionPopUp> {
