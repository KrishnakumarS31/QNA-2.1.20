...
class TeacherQuestionPreviewDeleteState extends State<TeacherQuestionPreviewDelete> {
  String? _groupValue;
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          Provider.of<QuestionPrepareProvider>(context, listen: false).deleteQuestionList(widget.index);
                          Navigator.push(
                            context,
                            PageTransition(
                              type: PageTransitionType.rightToLeft,
