                ...
                body: widget.givenMark == 0
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding:
                          EdgeInsets.only(bottom: localHeight * 0.0050),
                          child: Column(
                            children: [
                              Text(
                                ...
                                child: Card(
                                  ...
                                  child: Column(children: [
                                    ...
                                    Row(
                                        ...
                                        children: [
                                          Text(
                                              "${widget.questions.data!.assessmentType}" ==
                                                  "practice"
                                                  ? "Practice"
                                                  : '',
                                              //"Practice",
                              ...
                              SizedBox(
                                ...
                                child: Card(
                                  ...
                                  child: Column(children: [
                                    ...
                                    Text(
                                        '${widget.totalMarks}/${widget.givenMark}',
                                        style: TextStyle(
                                            color: const Color.fromRGBO(
                                                255, 153, 0, 1),
                                            fontWeight: FontWeight.w500,
              ...
              child: Scaffold(
                ...
                body: widget.givenMark == 0
                  ...
                  children: [
                    Padding(
                      padding: EdgeInsets.only(
                          bottom: localHeight * 0.00500,
                          left: localHeight * 0.1,
                          right: localHeight * 0.1),
                      child: Column(
                        children: [
                          Text(
                            widget.organisationName,
