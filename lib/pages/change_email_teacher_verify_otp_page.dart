...
class ChangeEmailTeacherVerifyOtpPage extends StatefulWidget {
  const ChangeEmailTeacherVerifyOtpPage({
    Key? key,
  ...
  @override
  ChangeEmailTeacherVerifyOtpPageState createState() => ChangeEmailTeacherVerifyOtpPageState();
}

class ChangeEmailTeacherVerifyOtpPageState extends State<ChangeEmailTeacherVerifyOtpPage> {
                                            ...
                                            children: [
                                              ...
                                              enableResendButton
                                                  ...
                                                  onPressed: enableResendButton ?
                                                    ...
                                                    response = await QnaService.sendEmailOtpService(
                                                        widget.email,widget.userDetails);
