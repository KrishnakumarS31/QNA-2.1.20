...
class StudentEditProfilePage extends StatefulWidget {
  const StudentEditProfilePage({super.key, required this.userDataModel});
  final UserDataModel userDataModel;
  @override
  StudentEditProfilePageState createState() => StudentEditProfilePageState();
}

class StudentEditProfilePageState extends State<StudentEditProfilePage> {
                                    ...
                                    children: [
                                      SizedBox(
                                        child: Column(
                                            ...
                                            //                activeColor: const Color.fromRGBO(82, 165, 160, 1),
                                            //                value: "yes",
                                            //                groupValue: enableAsTeacher,
                                            //                onChanged: (value) {
                                            //                  setState(() {
                                            //                    enableAsTeacher =
                                            //                    value..toString();
                                            //                    roleBackup.add('teacher');
                                            //                  });
                                            //                },
                                            //              ),
                                            //              Text(
  ...
  showAlertDialog(BuildContext context,StudentRegistrationModel student) {
    // set up the button
