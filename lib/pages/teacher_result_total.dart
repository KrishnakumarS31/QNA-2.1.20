            ...
            appBar: AppBar(
              ...
              title: Column(
                  ...
                  children: [
                    ...
                    Text(
                      AppLocalizations.of(context)!.total_caps,
                      //"TOTAL",
                      style: TextStyle(
                        color: const Color.fromRGBO(255, 255, 255, 1),
...
//'Subject - ${widget.result.subject}',
                                  ...
                                  trailing: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        (widget.result.assessmentResults != null && widget.result.assessmentResults?.isEmpty == false )? convertDate(widget.result.assessmentStartDate) : " ",
                                        style: TextStyle(
                                            color: const Color.fromRGBO(
                                                102, 102, 102, 1),
                      ...
                      Align(
                        ...
                        child: Text(
                          ...
                          widget.result.assessmentResults!.length != null
                              ?  "${AppLocalizations.of(context)!.total_parti_list} (${widget.result.assessmentResults!.length})"
