...
class TeacherResultAssessment extends StatefulWidget {
  TeacherResultAssessment({
    Key? key, required this.result, this.userId, this.advisorName,
  }) : super(key: key);
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        PageTransition(
                          ...
                          child: TeacherResultTotal(result : widget.result,userId: widget.userId,advisorName: widget.advisorName),
                        ),
                      );
                    },
                    child: Container(
